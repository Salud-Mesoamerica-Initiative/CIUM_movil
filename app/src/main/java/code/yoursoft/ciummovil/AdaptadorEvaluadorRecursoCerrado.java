...
public class AdaptadorEvaluadorRecursoCerrado extends RecyclerView.Adapter<ViewHolderERCerrado>
{

    private List<DataEvaluadorRecurso> paletas;
    ...
    public AdaptadorEvaluadorRecursoCerrado(List<DataEvaluadorRecurso> paletas,Context context  )
    {
    ...
    @Override
    public ViewHolderERCerrado onCreateViewHolder(ViewGroup viewGroup, int i)
    {

        View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.card_view_er_cerrado, viewGroup, false);

        return new ViewHolderERCerrado(itemView);
    }

    @Override
        public void onBindViewHolder(final ViewHolderERCerrado pVH, int i)
    {
...
/*
 ...
 class ViewHolderERCerrado  extends RecyclerView.ViewHolder
{
    ...
    public ViewHolderERCerrado(View itemView)
    {
        super(itemView);
