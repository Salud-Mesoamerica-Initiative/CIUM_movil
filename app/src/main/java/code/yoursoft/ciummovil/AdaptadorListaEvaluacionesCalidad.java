...
public class AdaptadorListaEvaluacionesCalidad extends RecyclerView.Adapter<ViewHolderEvaluacionCalidad>
{
    ...
    public AdaptadorListaEvaluacionesCalidad(List<EvaluacionDetalles> palettes, Context context)
    {
    ...
    @Override
    public ViewHolderEvaluacionCalidad onCreateViewHolder(ViewGroup viewGroup, int i)
    {
         View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.card_view_calidad, viewGroup, false);

        return new ViewHolderEvaluacionCalidad(itemView);
    }

    @Override
    public void onBindViewHolder(ViewHolderEvaluacionCalidad paletaViewHolder, int i) {
        ...
        paletaViewHolder.municipio.setText(paleta.getCluesMunicipio());

        paletaViewHolder.indicadores.setText(""+paleta.indicadores);
        paletaViewHolder.expedientes.setText(""+paleta.expedientes);
        paletaViewHolder.criterios.setText(paleta.avanceCriterios+" / "+paleta.criterios);

        paletaViewHolder.usuario.setText("Evaluador : "+paleta.getUsuarioNombre());
 ...
 class ViewHolderEvaluacionCalidad extends RecyclerView.ViewHolder
{
    ...
    protected TextView indicadores;
    protected TextView expedientes;
    protected TextView criterios;
    ...
    public ViewHolderEvaluacionCalidad(View itemView)
    {
        super(itemView);
        ...
        municipio = (TextView) itemView.findViewById(R.id.text_municipio);

        indicadores = (TextView) itemView.findViewById(R.id.text_indicadores);
        expedientes = (TextView) itemView.findViewById(R.id.text_expedientes);
        criterios = (TextView) itemView.findViewById(R.id.text_criterios);
